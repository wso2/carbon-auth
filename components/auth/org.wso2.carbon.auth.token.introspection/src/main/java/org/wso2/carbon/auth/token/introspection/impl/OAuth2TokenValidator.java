...
public class OAuth2TokenValidator implements TokenValidator {
    @Override
    public boolean validateAccessDelegation(IntrospectionContext context) throws IntrospectionException {
        return true;
    }

    @Override
    public boolean validateScope(IntrospectionContext context) throws IntrospectionException {
        return true;
    }

    @Override
    public boolean validateAccessToken(IntrospectionContext context) throws IntrospectionException {
        return true;
    }
