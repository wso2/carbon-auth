...
/**
 * Service Component to register Interceptors
 */
@Component(
        name = "org.wso2.carbon.auth.rest.api.commons.internal.AuthCommonServiceComponent",
...
public class AuthCommonServiceComponent extends OSGiInterceptorConfig {
    ...
    protected void start(BundleContext bundleContext) {
        addGlobalRequestInterceptors(new RestAPIAuthCORSInterceptor());
    }
}
