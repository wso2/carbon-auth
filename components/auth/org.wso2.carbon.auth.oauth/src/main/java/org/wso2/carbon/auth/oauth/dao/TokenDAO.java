...
public interface TokenDAO {
    void persistToken(String accessToken, String refreshToken, String clientID, String authUser, String userDomain,
            long timeCreated, long refreshTokenCreatedTime, int validityPeriod, int refreshTokenValidityPeriod,
            String tokenScopeHash, String tokenState, String userType, String grantType) throws SQLException;
