...
public class AuthCoreDAOTest extends AuthDAOIntegrationTestBase {

    private static final Logger log = LoggerFactory.getLogger(AuthCoreDAOTest.class);

    public AuthCoreDAOTest() {
    }
    ...
    public void testDAO() throws Exception {
        ...
        Assert.assertTrue(DAOUtil.isAutoCommitUM(), "Autocommit set to true in um DB but was false");
