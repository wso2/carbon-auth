...
/**
 * Top level exception class of User Core exceptions
 *
 */
public class UserCoreException extends Exception {
     ...
     */
    protected UserCoreException(String message, Throwable cause, boolean enableSuppression,
     ...
     */
    public UserCoreException(String message, ExceptionCodeHandler code) {
        super(message);
     ...
     * @param code Exception code that need to pass to the error DTO
     */
    public UserCoreException(String message, Throwable cause, ExceptionCodeHandler code) {
        super(message, cause);
        this.errorHandler = code;
    }
