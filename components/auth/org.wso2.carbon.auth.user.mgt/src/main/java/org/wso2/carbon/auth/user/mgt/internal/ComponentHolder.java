...
/**
 * Holder class for user management component
 */
public class ComponentHolder {
    ...
    public static void setUserStoreConnector(UserStoreConnector userStoreConnector) {
        ComponentHolder.userStoreConnector = userStoreConnector;
    }
}
