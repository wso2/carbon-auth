...
public class ServiceReferenceHolderTest {
    ...
    public void testComponentHolder() throws Exception {
        UserStoreConfigurationService userStoreConfigurationService = new UserStoreConfigurationService(
                new UserStoreConfiguration());
        ServiceReferenceHolder.getInstance().setUserStoreConfigurationService(userStoreConfigurationService);
        UserStoreConfigurationService retrieved = ServiceReferenceHolder.getInstance()
                .getUserStoreConfigurationService();
        Assert.assertEquals(userStoreConfigurationService, retrieved);
    }
}
