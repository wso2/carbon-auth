...
public interface RESTAPIAuthenticator {
     ...
     * @param method    Contains details about the HTTP method
     * @return authentication status. true if authentication is successful; else false.
     * @throws RestAPIAuthSecurityException If failed to authenticate the request.
     */
    boolean authenticate(Request request, Response responder, Method method)
